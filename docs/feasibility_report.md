...
| 9 | Estatísticas antes/depois | **SIM (2026-09-05)** — médias h/célula-mês pré→pós: MONA 0,264→0,252 (−4,6%); APA 0,133→0,699 (+425,6%); controle 1,502→1,562 (+4,0%). `outputs/diagnostics/pilot_effort_summary.md` — brutas, sem valor causal. **Ressalva D13 (10/09):** níveis brutos do GFW não são comparáveis entre períodos por causa da expansão de cobertura AIS; aqui o risco é baixo (controle +4,0% indica cobertura madura na região oceânica, contra +128% medidos na costa SE/S), mas a leitura válida continua sendo a do modelo com efeitos fixos de ano-mês |
